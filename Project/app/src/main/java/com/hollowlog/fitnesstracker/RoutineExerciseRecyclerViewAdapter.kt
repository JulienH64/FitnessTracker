...
internal class RoutineExerciseRecyclerViewAdapter(
    private var mExercises: List<ExerciseObject>,
    private val mRowLayout: Int,
    private val mContext: Context
) : RecyclerView.Adapter<RoutineExerciseRecyclerViewAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, i: Int) {
        ...
        viewHolder.itemView.setOnClickListener { v ->
            ...
            val intent = Intent(v.context, EditRoutine::class.java)
            val bundle = Bundle()
            intent.putExtra("name", viewHolder.mName.text)
            ActivityCompat.startActivityForResult(mContext as Activity, intent, 3, bundle)
        }
    }
